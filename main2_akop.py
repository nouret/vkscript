...
AT = "3f3a9551cc3a357ba1d04f0880db95f60c305f8926fc0d1873512d001df15e312bac5290bc3982da64a9a"
#session = vk.Session()
...
while True:
    ...
    try:
        ...
        can = Last["comments"][1]["from_id"] != 458578456
        if can:
            capcha_sleep = 1
            api.board.createComment(access_token=AT, group_id='30666517', topic_id='25736069', message="0x0" + hex(total_comments)[2:])
            print("new comment", "0x0" + hex(total_comments)[2:], total_comments / (2**20), "I am akop")
